...
//    type: 'doughnut',
//    data: {
//        labels: ["Rent", "Internet", "Electricity", "water", "Car Insurance"],
//        datasets: [{
//            data: [55, 30, 15, 10, 90, 50],
//            backgroundColor: ['#4e73df', '#1cc88a', '#36b9cc', '#777555', '#333555', '#FF0000'],
...
////document.getElementById('test1').textContent = newSum; entById("ChangeGoal1").innerHTML = "Welcome " + name;
//////}
//////function totalBudget(chart) {
//////    let sum = 0;
//////    let i = 0;
